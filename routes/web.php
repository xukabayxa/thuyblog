...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'teachers'], function () {
        Route::get('/', 'Admin\TeacherController@index')->name('Teacher.index');
        Route::get('/create', 'Admin\TeacherController@create')->name('Teacher.create');
        Route::get('/searchData', 'Admin\TeacherController@searchData')->name('Teacher.searchData');
        Route::post('', 'Admin\TeacherController@store')->name('Teacher.store');
        Route::get('/{id}/edit', 'Admin\TeacherController@edit')->name('Teacher.edit');
        Route::post('/{id}/update', 'Admin\TeacherController@update')->name('Teacher.update');
        Route::get('/{id}/delete', 'Admin\TeacherController@delete')->name('Teacher.delete');

    });

    Route::group(['prefix' => 'courses'], function () {
        Route::get('/', 'Admin\CourseController@index')->name('Courses.index');
        Route::get('/create', 'Admin\CourseController@create')->name('Courses.create');
        Route::get('/searchData', 'Admin\CourseController@searchData')->name('Courses.searchData');
        Route::post('', 'Admin\CourseController@store')->name('Courses.store');
        Route::get('/{id}/edit', 'Admin\CourseController@edit')->name('Courses.edit');
        Route::post('/{id}/update', 'Admin\CourseController@update')->name('Courses.update');
        Route::get('/{id}/delete', 'Admin\CourseController@delete')->name('Courses.delete');
    });
    ...
    Route::group(['prefix' => 'feedbacks'], function () {
        Route::get('/', 'Admin\FeedbackController@index')->name('feedbacks.index');
        Route::get('/searchData', 'Admin\FeedbackController@searchData')->name('feedbacks.searchData');
        Route::get('/{id}/show', 'Admin\FeedbackController@show')->name('feedbacks.show');
        Route::get('/create', 'Admin\FeedbackController@create')->name('feedbacks.create');
        Route::post('/', 'Admin\FeedbackController@store')->name('feedbacks.store');
        Route::post('/{id}/update', 'Admin\FeedbackController@update')->name('feedbacks.update');
        Route::get('/{id}/delete', 'Admin\FeedbackController@delete')->name('feedbacks.delete');
        Route::get('/{id}/getDataForEdit', 'Admin\FeedbackController@getDataForEdit');
    });
