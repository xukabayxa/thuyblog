<div class="row">
	<div class="col-md-9 col-sm-8 col-xs-12">
		...
		<div class="form-group custom-group mb-4">
			...
			<textarea id="my-textarea" class="form-control" ng-model="form.intro" rows="5"></textarea>
			<span class="invalid-feedback d-block" role="alert">
	...
	<div class="col-md-3 col-sm-4 col-xs-12">
        ...
        <div class="form-group custom-group mb-4">
            ...
            <select id="my-select" class="form-control custom-select" ng-model="form.pin">
                <option value=""></option>
                <option ng-repeat="p in form.pins" ng-value="p.id" ng-selected="form.pin == p.id"><% p.name %></option>
            </select>
        </div>
