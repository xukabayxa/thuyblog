...
<script>
    let datatable = new DATATABLE('table-list', {
        ...
        columns: [
            ...
            {
                data: 'pin',
                title: "Ghim ngoài trang chủ",
                render: function (data) {
                    return getStatus(data, @json(App\Model\Admin\Post::PINS));
                }
            },
        ...
        search_columns: [
            ...
            {
                data: 'pin', search_type: "select", placeholder: "Ghim ngoài trang chủ",
                column_data: @json(App\Model\Admin\Post::PINS)
            },
            {
