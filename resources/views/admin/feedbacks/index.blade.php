...
<div ng-cloak>
    ...
    {{-- Form tạo mới --}}
    @include('admin.feedbacks.create')
    @include('admin.feedbacks.edit')
</div>
@endsection

@section('script')
@include('admin.feedbacks.Feedback')
<script>
    let datatable = new DATATABLE('table-list', {
        ajax: {
            url: '{!! route('feedbacks.searchData') !!}',
        ...
        columns: [
            ...
            {data: 'customer_address', title: 'Địa chỉ'},
    ...
    app.controller('Consultants', function ($rootScope, $scope, $http) {
        ...
        $('#table-list').on('click', '.edit', function () {
            ...
            $.ajax({
                type: 'GET',
                url: "/admin/feedbacks/" + $scope.data.id + "/getDataForEdit",
                headers: {
