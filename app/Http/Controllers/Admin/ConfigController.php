...
class ConfigController extends Controller
{
	...
	public function update(Request $request)
	{
		...
		try {
			...
			$object->about1 = $request->about1;
			$object->about2 = $request->about2;
			$object->line_text_1 = $request->line_text_1;
			$object->line_text_2 = $request->line_text_2;
			$object->line_text_3 = $request->line_text_3;
